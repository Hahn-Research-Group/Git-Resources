...
- Branch
  - An independent line of commits of your repository 
-Fork
  - A copy of someone else's GitHub repository that you can edit
...
git commit -m "I fixed so many things!" # make a commit with a message `-m`
...
## Pushing your local git repo onto your online GitHub repo

```{bash, eval = F, echo=T}
git remote add origin https://github.com/[your-username]/[repository-name.git]
git push -u origin main 
# Pushing your origin (local repo) to the Hub (online repo) on a branch titled 'main'
```

After sending git push, your terminal will ask for your GitHub username and password/PAT
...
Git has an incredibly steep learning curve but it's version control and reproducibility features make it worth it. 
